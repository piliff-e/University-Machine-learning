...
Применяет сохранённые модели в models/ к изображениям в dataset/test/<class>/.
Сохраняет CSV с предсказаниями (reports/test_predictions.csv) и сохраняет confusion matrices.

Запуск:
    python3 test.py --data_dir dataset/test
"""
