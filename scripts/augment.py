...
- повышение устойчивости моделей к поворотам, отражениям и шумам;
- генерация нескольких аугментированных версий каждого исходного изображения.

Используемая библиотека:
- MONAI (набор медицинских и универсальных трансформаций изображений).

Результат:
- аугментированные изображения сохраняются рядом с исходными с добавлением суффикса *_augN.
"""
