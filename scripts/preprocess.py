...
Класс = часть имени до первого "_": down / one / up.

Пайплайн:
- читает все изображения из raw_dir
- извлекает класс по префиксу
- ресайзит с сохранением аспект-ратио и паддингом
- сохраняет в out_dir/preprocessed/train/<class>/
"""
